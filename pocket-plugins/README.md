...
| Dispensery | Dispensers place configured blocks (anvil by default), fill or empty cauldrons from buckets, and carve a pumpkin in front into a carved pumpkin with dispensed shears |
